...
class Constraint(_object):
    ...
    __swig_getmethods__["coincident"] = lambda x: _slvs.Constraint_coincident
    if _newclass:
...
def Constraint_some_other_constraint(*args):
...
class System(Slvs_System):
    ...
    def add_entity(self, p):
        return _slvs.System_add_entity(self, p)

    def add_entity_with_next_handle(self, p):
    ...
    def add_point2d(self, workplane, u, v, group=0):
        return _slvs.System_add_point2d(self, workplane, u, v, group)

    def add_point3d(self, x, y, z, group=0):
